    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + '"><i class="fa fa-arrow-circle-o-left"></i></div><div class="' + SLIDES_ARROW_NEXT + '"><i class="fa fa-arrow-circle-o-right"></i></div>');
